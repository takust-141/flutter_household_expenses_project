...
class RegisterRecurringKeyboardAction {
  RegisterRecurringKeyboardAction({
    ...
    required this.startDateNode,
    required this.endDateNode,
  ...
  final CustomFocusNode startDateNode;
  final CustomFocusNode endDateNode;
        ...
        KeyboardActionsItem(
          ...
          toolbarButtons: [
            (node) => Padding(
                  padding: keyboardInkWellPadding,
                  child: KeyboardGestureDetector(
                    onTapIcon: () => endDateNotifier.value = null,
                    customIcon: const Text("設定しない"),
                    isCircle: false,
                  ),
                ),
            (node) => Padding(
...
class CategoryPickerKeyboard extends ConsumerWidget
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final selectCategoryNotifer = ref.read(selectCategoryProvider.notifier);
            ...
            children: <Widget>[
              sub
                  ? CategoryKeyboardPanel(
                      category: null,
                      onTap: () {
                        selectCategoryNotifer.updateSelectSubCategory(null);
                      },
                      width: itemWidth,
                      height: itemHeight,
                      notifier: notifier,
