...
class _CalendarPageState extends ConsumerState<CalendarPage> {
  ...
  void initState() {
    super.initState();
    _pageViewController =
        PageController(initialPage: calcDiffMonthIndex(currentMonth));
  ...
  Widget build(BuildContext context) {
    ...
    final viewMonth = useState<DateTime>(currentMonth);
    ...
    ValueNotifier<DateTime> selectDate = ValueNotifier(currentMonth);
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          if (!showScrollView.value) {
                            _listWheelYearController =
                                FixedExtentScrollController(
                                    initialItem: viewMonth.value.year -
                                        currentMonth.year +
                                        100);
                            _listWheelMonthController =
                                FixedExtentScrollController(
                                    initialItem: viewMonth.value.month - 1);
                          } else {
                            _pageViewController = PageController(
                                initialPage:
                                    calcDiffMonthIndex(viewMonth.value));
                          }
